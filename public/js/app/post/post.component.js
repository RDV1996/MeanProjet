...
var PostComponent = /** @class */ (function () {
    function PostComponent(sanitizer, router, route, authService, paginaService, postService, commentService) {
        ...
        this.thisID = "";
        this.post = new Post("", "", false, "", "", [], "", [], new Date());
        this.urlReady = false;
        this.userName = "";
    ...
    PostComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.postService.getPostById(_this.thisID).subscribe(function (data) {
                ...
                _this.paginaService.getPageById(_this.post.pagina).subscribe(function (data) {
                    _this.pagina = _this.paginaService.setPagina(data.pagina);
                });
