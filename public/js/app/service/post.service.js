...
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.getPostsByUser = function (id, page) {
        var headers = new Headers({ 'Content-type': 'application/json' });
    ...
    PostService.prototype.getPostsByName = function (name, page) {
        var headers = new Headers({ 'Content-type': 'application/json' });
    ...
    PostService.prototype.deleteAllPostsFromPage = function (id) {
        var headers = new Headers({ 'Content-type': 'application/json' });
